...
function getOrders(n) {
    for (var f = [], r = [], u = [], i, t = 0; t < n; t++) r[t] = t, u[t] = 1;
    for (; ;) {
        for (f.push(r.clone()), u[r[n - 1]] = 0, t = n - 2; t >= 0; t--) if (u[r[t]] = 0, r[t] < r[t + 1]) break;
        if (t < 0) break;
        for (i = r[t] + 1; i < n; i++) if (!u[i]) break;
        for (u[i] = 1, r[t] = i, i = 0, t++; t < n; i++) u[i] || (r[t++] = i, u[i] = 1)
    }
    return f
}

function arrayInAllOrder(n) {
    for (var i = [], r = getOrders(n.length), t = r.shift(); t;) i.push(n.clone().reOrder(t)), t = r.shift();
    return i
}
...
(function (n, t) {
    ...
    var et, bi, o = typeof t, hf = n.location, r = n.document, ki = r.documentElement, cf = n.jQuery, lf = n.$, ot = {},
        b = [], bt = "1.10.2", di = b.concat, kt = b.push, l = b.slice, gi = b.indexOf, af = ot.toString,
 ...
 */
    ...
    function p() {
        ...
        this.dpDiv = w(n("<div id='" + this._mainDivId + "' class='ui-datepicker ui-widget ui-widget-content ui-helper-clearfix ui-corner-all'><\/div>"))
    }
    ...
    var l, f, k, i, d, g, nt, tt, it, ut, r, et, ot, st, ht, ct, o, s, lt, at, vt, yt, pt, wt, bt, kt, dt, gt, ni, ti,
        ii, ri, ui, fi, ei, oi, si, hi, ci, li, ai, vi;
    n.ui = n.ui || {};
    n.extend(n.ui, {
        version: "1.11.2",
        keyCode: {
    ...
    n.fn.extend({
        scrollParent: function (t) {
            var i = this.css("position"), u = i === "absolute", f = t ? /(auto|scroll|hidden)/ : /(auto|scroll)/,
    ...
    n("<a>").outerWidth(1).jquery || n.each(["Width", "Height"], function (t, i) {
        ...
        var e = i === "Width" ? ["Left", "Right"] : ["Top", "Bottom"], r = i.toLowerCase(), u = {
 ...
 */
    ...
    n.widget.extend = function (t) {
        for (var e = f.call(arguments, 1), u = 0, o = e.length, i, r; u < o; u++) for (i in e[u]) r = e[u][i], e[u].hasOwnProperty(i) && r !== undefined && (t[i] = n.isPlainObject(r) ? n.isPlainObject(t[i]) ? n.widget.extend({}, t[i], r) : n.widget.extend({}, r) : r);
        return t
    };
    n.widget.bridge = function (t, i) {
        var r = i.prototype.widgetFullName || t;
        n.fn[t] = function (u) {
            var s = typeof u == "string", o = f.call(arguments, 1), e = this;
        ...
        n.ui.position = {
            fit: {
                ...
                left: function (n, i) {
                    ...
                    var r = i.within, y = r.offset.top + r.scrollTop, a = r.height,
                        o = r.isWindow ? r.scrollTop : r.offset.top, v = n.top - i.collisionPosition.marginTop,
                        s = v - o, h = v + i.collisionHeight - a - o, p = i.my[1] === "top",
            ...
            var t, i, r, u, e, o = document.getElementsByTagName("body")[0], s = document.createElement("div");
 ...
 */
    nt = n.widget("ui.accordion", {
        ...
        _animate: function (n, t, i) {
            var h, r, u, c = this, o = 0, l = n.length && (!t.length || n.index() < t.index()),
                e = this.options.animate || {}, f = l && e.down || e, s = function () {
                    c._toggleComplete(i)
                };
            ...
            t.animate(this.hideProps, {
                duration: u, easing: r, step: function (n, t) {
                    t.now = Math.round(n)
                }
            });
 ...
 */
    var e, a = "ui-button ui-widget ui-state-default ui-corner-all",
    ...
    n.widget("ui.button", {
        ...
        _create: function () {
            this.element.closest("form").unbind("reset" + this.eventNamespace).bind("reset" + this.eventNamespace, rt);
            ...
            var i = this, t = this.options, r = this.type === "checkbox" || this.type === "radio",
                u = r ? "" : "ui-state-active";
        ...
        _destroy: function () {
            ...
            this.buttonElement.removeClass(a + " ui-state-active " + v).removeAttr("role").removeAttr("aria-pressed").html(this.buttonElement.find(".ui-button-text").html());
        ...
        refresh: function () {
            ...
            this.type === "radio" ? y(this.element[0]).each(function () {
        ...
        _resetButton: function () {
            ...
            var i = this.buttonElement.removeClass(v),
    ...
    n.widget("ui.buttonset", {
        ...
        refresh: function () {
            var i = this.element.css("direction") === "rtl", t = this.element.find(this.options.items),
    ...
    n.extend(p.prototype, {
        ...
        _newInst: function (t, i) {
            ...
            return {
                ...
                drawYear: 0,
                inline: i,
                dpDiv: i ? w(n("<div class='" + this._inlineClass + " ui-datepicker ui-widget ui-widget-content ui-helper-clearfix ui-corner-all'><\/div>")) : this.dpDiv
            }
        },
        ...
        _updateDatepicker: function (t) {
            ...
            var i, u = this._getNumberOfMonths(t), f = u[1], e = t.dpDiv.find("." + this._dayOverClass + " a");
            e.length > 0 && b.apply(e.get(0));
        ...
        parseDate: function (t, i, r) {
            ...
            for (var a, v, f = 0, y = (r ? r.shortYearCutoff : null) || this._defaults.shortYearCutoff, d = typeof y != "string" ? y : (new Date).getFullYear() % 100 + parseInt(y, 10), g = (r ? r.dayNamesShort : null) || this._defaults.dayNamesShort, nt = (r ? r.dayNames : null) || this._defaults.dayNames, tt = (r ? r.monthNamesShort : null) || this._defaults.monthNamesShort, it = (r ? r.monthNames : null) || this._defaults.monthNames, e = -1, s = -1, h = -1, p = -1, w = !1, u, l = function (n) {
                ...
                var u = l(n), r = n === "@" ? 14 : n === "!" ? 20 : n === "y" && u ? 4 : n === "o" ? 3 : 2,
                    e = n === "y" ? r : 1, o = new RegExp("^\\d{" + e + "," + r + "}"), t = i.substring(f).match(o);
 ...
 */
    n.widget("ui.draggable", n.ui.mouse, {
        ...
        _convertPositionTo: function (n, t) {
            t || (t = this.position);
            var i = n === "absolute" ? 1 : -1, r = this._isRootNode(this.scrollParent[0]);
            return {
    ...
    n.ui.plugin.add("draggable", "snap", {
        start: function (t, i, r) {
            ...
            for (var e, o, s, h, c, a, l, v, w, b = r.options, f = b.snapTolerance, y = i.offset.left, k = y + r.helperProportions.width, p = i.offset.top, d = p + r.helperProportions.height, u = r.snapElements.length - 1; u >= 0; u--) {
                ...
                }).left), h && (i.position.left = r._convertPositionTo("relative", {top: 0, left: a}).left));
                w = e || o || s || h;
 ...
 */
    n.widget("ui.resizable", n.ui.mouse, {
        ...
        _proportionallyResize: function () {
            if (this._proportionallyResizeElements.length) for (var n, t = 0, i = this.helper || this.element; t < this._proportionallyResizeElements.length; t++) n = this._proportionallyResizeElements[t], this.outerDimensions || (this.outerDimensions = this._getPaddingPlusBorderDimensions(n)), n.css({
    ...
    n.ui.plugin.add("resizable", "grid", {
        resize: function () {
            var h, t = n(this).resizable("instance"), i = t.options, y = t.size, e = t.originalSize,
                o = t.originalPosition, c = t.axis, l = typeof i.grid == "number" ? [i.grid, i.grid] : i.grid,
                s = l[0] || 1, f = l[1] || 1, a = Math.round((y.width - e.width) / s) * s,
                v = Math.round((y.height - e.height) / f) * f, r = e.width + a, u = e.height + v,
                p = i.maxWidth && i.maxWidth < r, w = i.maxHeight && i.maxHeight < u, b = i.minWidth && i.minWidth > r,
    ...
    n.widget("ui.droppable", {
        ...
        _create: function () {
            ...
            this.proportions = function () {
                if (arguments.length) t = arguments[0]; else return t ? t : t = {
    ...
    (function (n, t) {
        ...
        n.each(["borderLeftStyle", "borderRightStyle", "borderBottomStyle", "borderTopStyle"], function (t, i) {
            n.fx.step[i] = function (n) {
                (n.end === "none" || n.setAttr) && (n.pos !== 1 || n.setAttr) || (s.style(n.elem, i, n.end), n.setAttr = !0)
            }
        });
        n.fn.addBack || (n.fn.addBack = function (n) {
            return this.add(n == null ? this.prevObject : this.prevObject.filter(n))
        ...
        n.fn.extend({
            addClass: function (t) {
                ...
                return function (i, r, u, f, e) {
                    return typeof r == "boolean" || r === undefined ? u ? n.effects.animateClass.call(this, r ? {add: i} : {remove: i}, u, f, e) : t.apply(this, arguments) : n.effects.animateClass.call(this, {toggle: i}, r, u, f)
                }
        ...
        n.extend(n.effects, {
            version: "1.11.2", save: function (n, t) {
                for (var i = 0; i < t.length; i++) t[i] !== null && n.data(o + t[i], n[0].style[t[i]])
            }, restore: function (n, t) {
                for (var r, i = 0; i < t.length; i++) t[i] !== null && (r = n.data(o + t[i]), r === undefined && (r = ""), n.css(t[i], r))
        ...
        n.fn.extend({
            effect: function () {
                function e(t) {
                    ...
                    var r = n(this), e = i.complete, u = i.mode;
                    (r.is(":hidden") ? u === "hide" : u === "show") ? (r[u](), o()) : f.call(r[0], i, o)
                }

                var i = t.apply(this, arguments), r = i.mode, u = i.queue, f = n.effects.effect[i.effect];
 ...
 */
    at = n.effects.effect.blind = function (t, i) {
        var r = n(this), s = ["position", "top", "bottom", "left", "right", "height", "width"],
            v = n.effects.setMode(r, t.mode || "hide"), y = t.direction || "up", f = /up|down|vertical/.test(y),
            h = f ? "height" : "width", c = f ? "top" : "left", p = /up|left|vertical|horizontal/.test(y), l = {},
            a = v === "show", u, e, o;
        ...
        l[h] = a ? e : 0;
        p || (r.css(f ? "bottom" : "right", 0).css(f ? "top" : "left", "auto").css({position: "absolute"}), l[c] = a ? o : e + o);
 ...
 */
    ci = n.widget("ui.sortable", n.ui.mouse, {
        ...
        _contactContainers: function (t) {
            ...
            if (e) if (this.containers.length === 1) this.containers[i].containerCache.over || (this.containers[i]._trigger("over", t, this._uiHash(this)), this.containers[i].containerCache.over = 1); else {
    ...
    vi = n.widget("ui.tooltip", {
        version: "1.11.2", options: {
            ...
            if (r) {
                ...
                this.options.track && t && /^mouse/.test(t.type) ? (this._on(this.document, {mousemove: h}), h(t)) : u.position(n.extend({of: i}, this.options.position));
                u.hide();
...
$(function () {
    ...
    $(window).ajaxSend(function (n, t, i) {
        i.loading && (n = "", "string" == typeof i.loading && (n = i.loading), t.loadingOverlay = $("<div>").addClass("loading_overlay").append($("<div>").append($("<span>").text(n))).appendTo("body"))
    });
    $(window).ajaxComplete(function (n, t, i) {
        i.loading && t.loadingOverlay && t.loadingOverlay.remove()
    })
}), function (n) {
    n.fn.delayClass = function (n, t) {
        var i = this;
        clearTimeout(this.data("_dc_timer_" + n));
        this.addClass(n);
        this.data("_dc_timer_" + n, setTimeout(function () {
            i.removeClass(n)
        }, t))
    };
    n.fn.vals = function (t) {
        var i = [];
        return n.isFunction(t) ? this.each(function () {
            var r = n(this).val(), r = t(r, this);
            i.push(r)
        }) : this.each(function () {
            i.push(n(this).val())
        }), i
    };
    n.fn.formData = function (t, i) {
        var r = {};
        return n("input,select,textarea", this).each(function () {
            var e = n(this), u = e.prop("tagName").toLowerCase(), f = e.prop("type").toLowerCase(), o;
            if (("input" != u || "radio" != f && "checkbox" != f || e.prop("checked")) && ((u = e.prop("name")) || (u = e.prop("id")), u && ((e = e.val()) || !t))) {
                if (f = r, !i) {
                    for (o = u.split("."); 1 < o.length;) u = o.shift(), null == f[u] && (f[u] = {}), f = f[u];
                    u = o.shift()
                }
                /\[\]$/.test(u) ? (u = u.substr(0, u.length - 2), o = f[u], o || (o = [], f[u] = o), o.push(e)) : f[u] = e
            }
        }), r
    };
    n.fn.onlyNumber = function () {
        n(this).keypress(function (n) {
            return n = n.which, 0 == n || 13 == n || 8 == n || 48 <= n && 57 >= n ? !0 : !1
        })
    }
}($);
...
String.prototype.padleft = function (n, t) {
    if (this.length < n) {
        t || (t = " ");
        for (var i = "", r = 0, u = n - this.length; r < u; r++) i += t;
        return i + this
    }
    return this
};
String.prototype.endWith = function (n) {
    return n == null || n == "" || this.length == 0 || n.length > this.length ? !1 : this.substring(this.length - n.length) == n ? !0 : !1
};
...
Date.prototype.format = function (n) {
    ...
    for (t in i) new RegExp("(" + t + ")").test(n) && (n = n.replace(RegExp.$1, 1 == RegExp.$1.length ? i[t] : ("00" + i[t]).substr(("" + i[t]).length)));
    return n
};
var LIBS = function () {
    function n(n, t, i) {
        var f;
        if (n || (n = {}), t) if ($.isArray(i)) for (f = 0; f < i.length; f++) {
            var r = i[f], u = t[r], e = n[r];
            void 0 !== u && u !== e && (n[r] = u)
        } else for (r in t) u = t[r], e = n[r], void 0 !== u && u !== e && (n[r] = u);
        return n
    }

    return {
        NUMBERS: "零一二三四五六七八九十".split(""), clone: n, money: function (n, t, i) {
            for (void 0 !== t && (n = this.round(n, t, i)), n = (n + "").split(".", 2), t = n[0], i = /(\d+)(\d{3})/; i.test(t);) t = t.replace(i, "$1,$2");
            return 1 < n.length && 0 < n[1].length && (t += "." + n[1]), t
        }, split: function (n, t, i) {
            var r = n.indexOf(t), f, u;
            if (-1 == r) return [n];
            for (f = [n.substr(0, r)], r = r + t.length; r < n.length;) u = n.indexOf(t, r), (-1 == u || f.length + 1 >= i) && (u = n.length), f.push(n.substring(r, u)), r = u + t.length;
            return f
        }, round: function (n, t, i) {
            if (null == n) return null;
            t || (t = 0);
            var r = Math.pow(10, t);
            if (n = Math.round(n * r) / r, 0 < t && i) for (n += "", r = n.indexOf("."), -1 == r && (r = n.length, n += "."), i = 0, t -= n.length - r - 1; i < t; i++) n += "0";
            return n
        }, combination: function (n, t) {
            if (n <= t) return 1;
            if (n == t + 1) return n;
            for (var r = n, i = n - 1; i > n - t; i--) r *= i;
            for (i = t; 1 < i; i--) r /= i;
            return r
        }, replaceArray: function (n, t) {
            var r, i, u;
            if (t) for (r = [], i = 0; i < n.length; i++) u = t[n[i]], null == u ? r.push(n[i]) : r.push(u);
            return r
        }, comboArray: function (n, t, i) {
            var u, r, e;
            if (null == i && (i = n.length), !(1 > t || 1 > i || t > i)) {
                for (var f = [], o = [], r = 0; r < t; r++) o[r] = r;
                for (; ;) {
                    for (u = [], r = 0; r < t; r++) u[r] = n[o[r]];
                    for (u.count = u[0].count, r = 1, e = u.length; r < e; r++) u.count *= u[r].count;
                    for (f[f.length] = u, u = r = t - 1; 0 <= r; r--) if (e = o[r] + 1, e >= i - u + r) {
                        if (0 == r) {
                            for (f.count = f[0].count, r = 1, e = f.length; r < e; r++) f.count += f[r].count;
                            return f
                        }
                    } else {
                        for (o[r] = e; r < u; r++) o[r + 1] = o[r] + 1;
                        break
                    }
                }
            }
        }, comboList: function (n) {
            for (var u, f = [], i = [], r = n.length, t = 0; t < r; t++) i[t] = 0;
            for (; ;) {
                for (u = [], t = 0; t < r; t++) u[t] = n[t][i[t]];
                for (f.push(u), t = 0; t < r; t++) {
                    if (i[t] += 1, i[t] < n[t].length) break;
                    if (t == r - 1) return f;
                    i[t] = 0
                }
            }
            ...
            return n -= 60 * t, 10 > t && (t = "0" + t), 10 > n && (n = "0" + n), "" + t + ":" + n
        }, ajaxDefaultTimeout: 1e4, ajax: function (t, i, r) {
            t && !t.timeout && (t.timeout = this.ajaxDefaultTimeout);
            i || (i = 2);
            r || (r = 1e3);
            var u = {}, f = 0, e = t.error, o = t.complete;
            return t.error = function (o, s) {
                if (clearTimeout(u.errTimer), ("timeout" == s || "error" == s && 503 == o.status) && (f += 1, f <= i || -1 == i)) {
                    delay = f * f * r;
                    u.errTimer = setTimeout(function () {
                        u = n(u, $.ajax(t))
                    }, delay);
                    this.retryError = !0;
                    return
                ...
                !this.retryError && $.isFunction(o) && o.apply(this, arguments)
            }, u = $.ajax(t)
        }, get: function (n, t, i, r, u, f) {
            return jQuery.isFunction(t) && (f = u, u = r, r = i, i = t, t = void 0), "string" == typeof r || $.isArray(r) || (f = u, u = r, r = void 0), this.ajax({
                url: n,
                type: "get",
                dataType: r,
                data: t,
        ...
        }, colorMoney: function (n, t, i) {
            (t || i) && $(n).each(function () {
                var n = $(this), r = n.text();
                n.removeClass(t).removeClass(i);
                r && "0" != r && ("-" == r[0] && t ? n.addClass(t) : i && n.addClass(i))
            })
        }, url: function (n, t) {
            var i, r, u, f, e;
            if (!n) return location.href;
            if (void 0 === t && (t = n, n = location.pathname), i = n.indexOf("?"), r = location.search, 0 <= i && (r = n.substr(i), n = n.substring(0, i)), i = n + "?", 1 < r.length) for (r = r.substr(1).split("&"), u = 0; u < r.length; u++) 0 != r[u].length && (f = r[u].split("=", 2), f[1] && void 0 === t[f[0]] && (t[f[0]] = decodeURIComponent(f[1])));
            for (e in t) t[e] && (i += e + "=" + encodeURIComponent(t[e]) + "&");
            return i.substr(0, i.length - 1)
        }, getUrlParam: function (n, t) {
            var i, r;
            if (t || (t = location.search), 1 < t.length) for (t = t.substr(1).split("&"), i = 0; i < t.length; i++) if (0 != t[i].length && (r = t[i].split("=", 2), r[1] && r[0] == n)) return decodeURIComponent(r[1])
        }, equals: function (n, t) {
            for (var i in n) if (n[i] != t[i]) return !1;
            return !0
        }, bindFocus: function (n) {
            return n.focusin(function () {
                $(this).addClass("input_focus")
            }).focusout(function () {
                $(this).removeClass("input_focus")
            }), n
        }, toMap: function (n, t, i) {
            var r, u;
            if (null == n) return {};
            for (t || (t = ";"), i || (i = "="), n = n.split(t), t = {}, r = 0; r < n.length - 1; r++) u = n[r].split(i, 2), 2 == u.length && (t[u[0]] = u[1]);
            return t
        }, cookie: function (n, t, i) {
            var r, u, f;
            if ("undefined" != typeof t) i = i || {}, null === t && (t = "", i.expires = -1), r = "", i.expires && ("number" == typeof i.expires || i.expires.toUTCString) && ("number" == typeof i.expires ? (r = new Date, r.setTime(r.getTime() + 864e5 * i.expires)) : r = i.expires, r = "; expires=" + r.toUTCString()), u = i.path ? "; path=" + i.path : "cookiepath", f = i.domain ? "; domain=" + i.domain : "", i = i.secure ? "; secure" : "", document.cookie = [n, "=", encodeURIComponent(t), r, u, f, i].join(""); else {
                if (t = null, document.cookie && "" != document.cookie) for (i = document.cookie.split(";"), d = 0; d < i.length; d++) if (u = jQuery.trim(i[d]), u.substring(0, n.length + 1) == n + "=") {
...
Array.prototype.distinct = function () {
    for (var t = this, i = {}, r = {}, f = [], n, u = 0; n = t[u]; u++) n in i ? (n in r || (r[n] = n), delete t[u]) : i[n] = n;
    t.length = 0;
    for (n in i) t.push(n);
    for (n in r) f.push(n);
    return f
...
Array.prototype.reOrder = function (n) {
    for (var i = this.clone(), t = 0; t < n.length; t++) this[n[t]] = i[t];
    return this
};
Array.prototype.unique = function () {
    return this.join(",").match(/([^,]+)(?!.*\1)/ig)
};
Array.prototype.removeItems = function (n) {
    for (var t = 0; t < this.length;) this[t] == n ? this.splice(t, 1) : t++
};
"object" != typeof JSON && (JSON = {}), function () {
    ...
    function r(i, e) {
        ...
        switch (typeof o) {
            ...
            case"object":
                if (!o) return "null";
                if (n += u, h = [], "[object Array]" === Object.prototype.toString.apply(o)) {
                    for (a = o.length, s = 0; s < a; s += 1) h[s] = r(s, o) || "null";
                    return c = 0 === h.length ? "[]" : n ? "[\n" + n + h.join(",\n" + n) + "\n" + v + "]" : "[" + h.join(",") + "]", n = v, c
                }
                if (t && "object" == typeof t) for (a = t.length, s = 0; s < a; s += 1) "string" == typeof t[s] && (l = t[s], (c = r(l, o)) && h.push(f(l) + (n ? ": " : ":") + c)); else for (l in o) Object.prototype.hasOwnProperty.call(o, l) && (c = r(l, o)) && h.push(f(l) + (n ? ": " : ":") + c);
                return c = 0 === h.length ? "{}" : n ? "{\n" + n + h.join(",\n" + n) + "\n" + v + "}" : "{" + h.join(",") + "}", n = v, c
        }
    }
    ...
    "function" != typeof JSON.parse && (JSON.parse = function (n, t) {
        function r(n, i) {
            var f, e, u = n[i];
            if (u && "object" == typeof u) for (f in u) Object.prototype.hasOwnProperty.call(u, f) && (e = r(u, f), void 0 !== e ? u[f] = e : delete u[f]);
            return t.call(n, i, u)
        }
        ...
        })), /^[\],:{}\s]*$/.test(n.replace(/\\(?:["\\\/bfnrt]|u[0-9a-fA-F]{4})/g, "@").replace(/"[^"\\\n\r]*"|true|false|null|-?\d+(?:\.\d*)?(?:[eE][+\-]?\d+)?/g, "]").replace(/(?:^|:|,)(?:\s*\[)+/g, ""))) return i = eval("(" + n + ")"), "function" == typeof t ? r({"": i}, "") : i;
